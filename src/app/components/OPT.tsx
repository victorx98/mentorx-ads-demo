...
const PAIN_POINTS = [
  {
    ...
    solution: '结合专业背景、求职阶段和目标地区，筛选高匹配岗位方向，明确优先级与投递顺序。',
  },
  {
    n: '02', title: '身份时间线压力大',
  ...
  return (
    <Sec id="solution" bg="white">
      <SecHead
        eyebrow="求职挑战和方案"
        title="毕业即就业，6 大求职挑战"
        sub="OPT/CPT 学生面临的不只是求职压力，还有身份时间线、岗位筛选、投递效率和面试推进的多重压力。越接近毕业，越需要把每一步都做得更精准。"
        center
      />
...
const BRAND_CARDS = [
  {
    ...
    title: '看清时间线',
    desc: '结合 CPT、OPT、毕业时间和目标岗位，判断当前最适合优先推进的求职路径。',
  },
  {
    number: '02',
    label: 'AI Matching',
    title: '精准提效率',
    desc: '借助 AI 分析与导师经验，快速定位简历、岗位匹配和面试准备中的关键短板。',
  },
  {
    number: '03',
    label: 'Offer Sprint',
    title: '极速上岸',
    desc: '顾问与导师跟进投递、面试和 Offer 节点，帮助学生在有限时间内更快接近目标机会。',
  },
];
