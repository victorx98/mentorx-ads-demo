...
const PILLARS = [
  {
    icon: Users2,
    title: '名企导师团队',
    desc: '业界一线导师 1 对 1，覆盖科技、金融、咨询与国内头部企业。',
  },
  {
    icon: Sparkles,
    title: 'AI 赋能课程体系',
    desc: '25 课时直播 + 150+ 课时录播，前沿技术与行业实战同步更新。',
  },
  {
    icon: Route,
    title: '求职全流程支持',
    desc: '简历、面试、内推、投递，每个环节都有人跟。',
  },
  {
    icon: Database,
    title: '海量资源加持',
    desc: '岗位库、资料库、人脉资源，中美两侧同时打开。',
  },
];
...
const CHALLENGES = [
  {
    n: '01', title: '时间线错位',
    desc: '美国校招 8–10 月开闸，国内秋招 9 月启动、春招 3 月，两边节奏不同，容易顾此失彼。',
    solution: '按毕业时间倒推，做一张中美并行的校招日历，明确每个月该做什么。',
  },
  {
    n: '02', title: '目标市场没想清',
    desc: '留美还是回国摇摆到大四才定，结果两边准备都不充分。',
    solution: '结合专业、签证、家庭与行业景气度做双市场评估，先定主线、再定备选。',
  },
  {
    n: '03', title: '实习经历不够看',
    desc: '校招最看重相关实习，但手上没有拿得出手的项目。',
    solution: '中美两侧各 1 个月远程实习项目，补齐简历上最关键的那一段。',
  },
  {
    n: '04', title: '一份简历投两个市场',
    desc: '美式 Résumé 与国内简历的写法、投递系统完全不同。',
    solution: '双版本简历 + LinkedIn / 国内求职平台分别优化，按市场投对格式。',
  },
  {
    n: '05', title: '笔面试形式差异大',
    desc: 'OA、BQ、Case 与群面、结构化面试，准备维度完全不一样。',
    solution: '分市场专项训练，配 2 次针对性 Mock Interview 与逐轮反馈。',
  },
  {
    n: '06', title: '投递效率低',
    desc: '一个人海投几百份没回音，也不知道问题卡在哪一环。',
    solution: '智能岗位筛选 + 最多 500 个岗位代投，配合内推与阶段复盘。',
  },
];
...
const US_TRACK = {
  ...
  tagline: '打造国际化竞争力',
  items: [
    { title: '美国远程实习项目（1 个月）', desc: '真实项目经验，提升国际职场适应力。' },
    { title: '美国名企远程实习项目（1 个月）', desc: '积累海外项目经历，增强简历亮点。' },
    { title: '美国就业通道', desc: '精准岗位推荐｜导师 1 对 1 辅导｜LinkedIn 优化｜美式面试技巧训练。' },
  ],
};
...
const CN_TRACK = {
  ...
  tagline: '深耕国内就业优势',
  items: [
    { title: '中国名企远程实习项目（1 个月）', desc: '熟悉国内职场环境，积累行业实践经验。' },
    { title: '中国就业通道', desc: '行业导师深度辅导｜网申优化与内推｜结构化面试训练｜国内校招节奏把控。' },
  ],
};

const STEPS = [
  { n: '01', title: '一对一导师辅导（共 15 课时）', points: ['10 课时业界导师指导', '5 课时专业导师综合能力提升'] },
  { n: '02', title: 'AI 赋能系列直播课（25 课时）', points: ['金融 / 计算机 / BA / 泛商科', 'AI 赋能实战课程'] },
  { n: '03', title: '求职文书精修（2 次）', points: ['简历精修｜求职信优化', 'LinkedIn 优化'] },
  { n: '04', title: '求职资料库', points: ['BQ 题库与最优解答', '150+ 课时行业知识录播'] },
  { n: '05', title: '面试模拟 & 技巧辅导', points: ['2 次针对性模拟面试', '历年面试真题详解与分析'] },
  { n: '06', title: '独家 Mock Interview 评估系统', points: ['不限次数练习｜AI 智能评估', '专业导师反馈提升'] },
  { n: '07', title: '不限次数就业导师在线咨询', points: ['岗位投递指导｜求职方法', '职场文化答疑'] },
  { n: '08', title: '岗位筛选投递平台', points: ['海量岗位资源库｜智能推荐匹配', '一键投递，提升效率'] },
  { n: '09', title: '20 次企业导师精准内推', points: ['匹配合适的企业岗位', '内推权益保证至少 20 次'] },
  { n: '10', title: '最多 500 个岗位代投服务', points: ['AI 智能投递｜简历持续优化', '提升简历曝光与面试机会'] },
];

const INCLUDED = [
  '就业导师全程跟带',
  '网申指导 + 代投（无限次，每周最多 25 次）',
  '求职账号建设指导',
  '网申信息整合',
  '内推（BD + 企业导师）',
  '面试练习（自我介绍 + 行为面 + 视频面）',
...
const TESTIMONIALS = [
  {
    quote: '秋招我同时在投美国和国内，导师帮我把两条时间线画在一张表上，才发现 9 月那两周才是真正的关键期。',
    name: 'Jess W.',
    tag: 'CMU 计算机 → Google SWE',
  },
  {
    quote: '国内网申的写法和美式简历完全是两回事，改完之后回复率明显不一样。',
    name: 'Ruoxi T.',
    tag: 'UIUC 商科 → 字节跳动 数据分析',
  },
  {
    quote: '群面和结构化面试我完全没经验，导师专门带我练了几轮，第一次真面就过了。',
    name: 'Kevin H.',
    tag: 'UT Austin 计算机 → 腾讯 后台开发',
  },
  {
    quote: '内推是真的有用。自己投三个月没动静，走内推两周就进了流程。',
    name: 'Michael L.',
    tag: 'Columbia 金融 → JPMorgan',
  },
  {
    quote: '实习那一个月给了我简历上最能讲的一段经历，面试有一半时间都在聊它。',
    name: 'Tina X.',
    tag: 'UCLA 统计 → Meta Data Analyst',
  },
  {
    quote: '最后是拿着两边的 offer 做的选择，那种感觉和被动接受完全不一样。',
    name: 'Brian W.',
...
const MENTORS = [
  {
    ...
    strength: '首席SDE，OA / 面试全流程', coaching: 'SDE技术面试、项目复盘', color: '#4285F4',
  },
  {
    name: 'Yuxin L.', title: '字节跳动 数据分析负责人', company: 'ByteDance', years: '7年+',
    strength: '国内校招面试官，带过完整秋招周期', coaching: '国内数据岗笔面试、结构化面试', color: '#3C8CFF',
  },
  {
    name: 'Crystal Z.', title: 'Morgan Stanley FICC VP', company: 'Morgan Stanley', years: '6年+',
    strength: '推动量化策略与投资决策', coaching: '案例面试、投资分析', color: '#0076CF',
  },
  {
    name: 'Haoran S.', title: '中金公司 投行部 VP', company: 'CICC', years: '9年+',
    strength: '国内金融校招与暑期实习选拔', coaching: '行研、群面与结构化面试', color: '#B01F24',
  },
  {
    name: 'Hang Y.', title: 'TikTok Software Engineer', company: 'TikTok', years: '7年',
    strength: '前Google工程师，参与校园招聘', coaching: '算法、系统设计', color: '#010101',
  },
  {
    name: 'Kevin L.', title: 'McKinsey Senior Associate', company: 'McKinsey', years: '6年+',
    strength: '战略咨询，McKinsey招聘官经验', coaching: 'Case Interview、简历润色', color: '#003B71',
  },
  {
    name: 'George Z.', title: 'Amazon Data Scientist', company: 'Amazon', years: '4年',
    strength: '数据岗目标岗位面试准备', coaching: 'SQL、逻辑面试', color: '#FF9900',
  },
  {
    name: 'Sophia R.', title: 'Meta Product Manager', company: 'Meta', years: '4年',
    strength: '跨职能产品负责人，擅长PM面试辅导', coaching: 'PM面试、产品设计题', color: '#0866FF',
  },
  {
    name: 'Michael T.', title: 'JPMorgan Quant Analyst', company: 'JPMorgan', years: '8年+',
    strength: '量化金融、金融工程面试辅导', coaching: '技术面试、行为面试', color: '#003087',
  },
  {
    name: 'Linda C.', title: 'Deloitte Senior Consultant', company: 'Deloitte', years: '5年',
    strength: '审计与管理咨询，Big4校招经验', coaching: '案例面试、简历优化', color: '#86BC25',
  },
];
...
const BRAND_CARDS = [
  {
    number: '01', label: 'Data Insight', title: '数据洞察',
    desc: '结合中美两侧学员案例与岗位趋势，判断更适合你的校招主线。',
  },
  {
    number: '02', label: 'AI Matching', title: 'AI 赋能',
    desc: '用 AI 分析简历、项目与岗位匹配度，让准备更聚焦、更高效。',
  },
  {
    number: '03', label: 'Dual Network', title: '双通道资源',
    desc: '美国与国内岗位资源、导师网络同时打开，不用提前二选一。',
  },
];
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        >
          ...
          <h3 className="mb-2 text-[20px] font-semibold leading-snug">扫码<span className="mx-1 inline-flex -translate-y-px items-center rounded-full bg-[#DFF5EC] px-2.5 py-0.5 text-[#00A870] shadow-[inset_0_0_0_1px_rgba(0,168,112,0.12)]">免费领取</span>校招时间线规划</h3>
          <p className="text-[13px] opacity-70 leading-relaxed">获取中美两侧岗位资源、简历建议与阶段任务表</p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-[minmax(0,1fr)_minmax(250px,0.86fr)] md:gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.92fr)] lg:gap-8 items-center min-w-0">
          ...
          <div className="order-1 min-w-0" style={{ maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)' }}>
            ...
            <p className="hidden text-[17px] leading-relaxed mb-5 max-w-[19rem] sm:max-w-md md:block" style={{ color: INK_MUTED, overflowWrap: 'anywhere' }}>
              从大二 / 硕一开始，按中美两套校招时间线并行准备——目标岗位、实习积累、简历与面试，一套系统陪你走到 Offer。
            </p>
            ...
            <p className="hidden text-[13px] font-semibold mb-6 md:block" style={{ color: INK_MUTED }}>
              30 分钟 1V1 评估｜判断目标市场、时间线，以及当前最该补的一环
            </p>
            ...
            <div className="grid grid-cols-3 gap-2 text-[10px] text-gray-500 sm:flex sm:flex-wrap sm:items-center sm:justify-start sm:gap-6 sm:text-[15px]">
              {['11年+ 服务经验', '33,000+ 学员', '中美双通道岗位'].map(t => (
                <div
                  key={t}
          ...
          <div className="order-2 flex justify-center md:justify-end min-w-0">
            <div className="relative w-full max-w-[350px] sm:max-w-[380px] md:w-[clamp(280px,38vw,420px)] md:max-w-none rounded-[16px]" style={{ boxShadow: '0 16px 48px rgba(17,24,39,0.08)' }}>
              ...
              <Badge text="美国 + 中国 双通道岗位" className="-top-3 left-0 sm:-left-8" style={heroTagStyle(-28, -0.15)} />
              <Badge
                text="名企导师 1v1 · 15 课时"
                sub="科技 · 金融 · 咨询"
              ...
              />
              <Badge text="校招时间线倒推规划" className="bottom-[18%] left-0 sm:-left-8" style={heroTagStyle(24, -2.05)} />
    ...
    <section id="stats" ref={sectionRef} style={{ background: CANVAS }} className="py-10 sm:py-12">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="text-center mb-6">
          <SecHead eyebrow="实力沉淀" title="11年深耕，陪留学生走好职业第一步" center />
        </div>
...
function ChallengesSection() {
  return (
    <Sec id="solution" bg="white">
      <SecHead
        eyebrow="校招挑战和方案"
        title="跨两个市场找工作，6 个绕不开的问题"
        sub="每一项都会影响校招节奏和最终结果。蔓藤从诊断开始，帮学生看清问题、补齐差距、把两条路都走通。"
        center
      />
  ...
  return (
    <Sec id="dual-track" bg={MINT_BAND} className="scroll-mt-16">
      <SecHead
        eyebrow="核心优势"
        title="一套准备，两个市场同时推进"
        sub="不用在「留美还是回国」之间提前赌一把。两条通道并行推进，等 Offer 在手，再做选择。"
        center
      />
        ...
        <div className="flex items-center justify-center py-2 lg:py-0">
          ...
          >
            <div>
              ...
              <div className="text-[15px] font-semibold leading-tight text-white">中美<br />双通道</div>
              <div className="mt-1 text-[11px]" style={{ color: '#9BE5C3' }}>校招双保险</div>
            </div>
          </div>
        </div>
...
function StepsSection() {
  return (
    <Sec id="steps" bg="white" className="scroll-mt-16">
      <SecHead
        eyebrow="赋能步骤"
        title="10 大求职赋能步骤，全流程陪伴"
        sub="从导师辅导到最终投递，每一步都有明确的交付内容和负责人，不靠学生自己摸索。"
        center
      />
      ...
      <div className="rounded-[16px] border bg-white p-6 sm:p-8" style={{ borderColor: 'rgba(0,168,112,0.14)', boxShadow: '0 16px 40px rgba(17,24,39,0.06)' }}>
        <div className="grid gap-6 lg:grid-cols-[220px_1fr] lg:gap-10">
          <div>
            ...
            <div className="mt-5">
              <Btn label="查看完整服务清单" onClick={onCTA} />
            </div>
          </div>
  ...
  return (
    <section id="mentors" className="py-10 md:py-14 overflow-hidden" style={{ background: MINT_BAND }}>
      <div className="max-w-6xl mx-auto px-5 sm:px-8 mb-6">
        <SecHead
          eyebrow="导师团队"
          title="教你的人，正在这些公司做校招面试官"
          sub="科技、金融、咨询与国内头部企业的一线从业者，带过完整校招周期，知道每一轮真正在筛什么。"
          center
        />
      </div>
    ...
    <section style={{ background: CANVAS }} className="py-12 sm:py-14" id="success">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex flex-col items-center text-center mb-6 [&>div]:mb-0">
          <SecHead
            eyebrow="学员故事"
            title="有人留在了美国，有人回国上岸"
            sub="他们的共同点不是运气好，而是在校招开始之前，就把两条路都准备清楚了。"
            center
          />
        </div>
    ...
    <Sec bg="white" id="aboutus" className="!py-14 sm:!py-16 scroll-mt-16">
      <div className="text-center mb-8">
        <SecHead
          ...
          sub="MentorX 将多年学员案例、中美岗位数据、AI 分析与名企导师经验结合，帮助学生从看清问题，到制定路径，再到持续行动。"
          center
        />
      </div>
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-8 items-center">
          <div>
            ...
            <h2 className="text-[28px] sm:text-[36px] lg:text-[42px] font-semibold leading-tight mb-4" style={{ color: INK, letterSpacing: '-0.03em' }}>
              校招时间线不等人，<br />
              <span style={{ color: GREEN_DARK }}>先花 30 分钟看清自己的位置</span>
            </h2>
            <p className="text-[15px] mb-0 max-w-xl leading-relaxed md:mb-6" style={{ color: INK_MUTED }}>
              还没想好留美还是回国？不确定现在该补实习还是练面试？先做一次免费校招诊断，让顾问帮你把时间线和优先级排出来。
            </p>
            <button
              onClick={onCTA}
          ...
          <div className="hidden bg-white rounded-[14px] p-6 w-full max-w-[260px] flex-shrink-0 border justify-self-start lg:block lg:justify-self-end" style={{ borderColor: 'rgba(0,168,112,0.14)' }}>
            <div className="text-[13px] font-semibold text-gray-900 mb-1 leading-snug">扫码领取校招时间线规划</div>
            <div className="text-[11px] text-gray-400 mb-4 leading-relaxed">获取中美两侧岗位资源、简历建议与阶段任务表</div>
    ...
    <footer style={{ background: CANVAS }}>
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-8">
        <div className="rounded-[14px] px-6 py-5 text-center" style={{ background: GREEN_DARK }}>
          <div className="text-[15px] font-semibold text-white sm:text-[17px]">
            全程陪伴 · 全程护航 · 助力学生斩获理想实习 &amp; 全职 Offer
          </div>
          <div className="mt-1.5 text-[12px]" style={{ color: '#9BE5C3' }}>
            求职规划，是未来的起点。现在开始准备，未来领先一步。
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="text-[12px]" style={{ color: INK_MUTED }}>
          ©2026, 蔓藤教育MentorX Corporation. All Rights Reserved · 专注留学生中美校招辅导
        </div>
      </div>
    </footer>
  );
...
const NAV_ITEMS = [
  { id: 'solution', label: '校招挑战' },
  { id: 'dual-track', label: '双通道优势' },
  { id: 'steps', label: '赋能步骤' },
