...
const PAIN_POINTS = [
  {
    n: '01', title: '	Need an Internship, but Your Profile Feels Thin?',
    desc: 'You are not sure which internships to target, and your resume lacks role-relevant projects or standout experience.',
    solution: 'Identify high-fit internship and early-career opportunities based on your major, background, and target direction.',
  },
  {
    n: '02', title: '	Applying for Full-Time Roles With No Momentum?',
    desc: 'Unclear role targeting, weak resume alignment, and scattered applications can lead to low response rates.',
    solution: 'Refine your resume, project stories, and interview positioning around what target roles actually expect.',
  },
  {
    n: '03', title: 'OPT/CPT Timeline Pressure?',
    desc: 'Work authorization deadlines, graduation timing, and recruiting windows can shrink your options fast.',
    solution: '		Keep applications, interviews, and offer progress moving with advisor and mentor support',
  },
  {
    n: '04', title: 'No Application Response',
    desc: 'You are applying broadly with little response and do not know where the issue is.',
    solution: 'Set a target list and application rhythm, using referrals and review cycles to improve conversion.',
  },
  {
    n: '05', title: 'Unstable Interview Performance',
    desc: 'Technical, behavioral, or case interview preparation is not systematic enough.',
    solution: 'Industry mentors run mock interviews to train answer frameworks and delivery.',
  },
  {
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-6 pb-5 lg:pt-8 lg:pb-6">
        <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(250px,0.78fr)] md:gap-7 lg:grid-cols-[minmax(0,1fr)_minmax(300px,0.78fr)] lg:gap-8 items-center min-w-0">
          ...
          <div className="order-1 min-w-0" style={{ maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)' }}>
            ...
            >
              International Student Career Launch Plan
            </div>
            ...
            >
              <span className="whitespace-nowrap">Helping More Students Cross</span><br />
              <span className="whitespace-nowrap">the Gap Between Campus and Career</span>
            </h1>
            ...
            <h1
              ...
              style={{ color: INK, letterSpacing: '-0.04em', maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)', wordBreak: 'keep-all', overflowWrap: 'normal' }}
            >
              <span className="block">Job Search Stuck?</span>
              <span className="block whitespace-nowrap" style={{ color: GREEN }}>Stop Applying Alone.</span>
            </h1>
            ...
            <p className="hidden text-[16px] leading-relaxed mb-4 max-w-[19rem] sm:max-w-md md:block" style={{ color: INK_MUTED, overflowWrap: 'anywhere' }}>
             Landing a job takes more than sending more resumes. MentorX helps international students sharpen their direction, improve their positioning, and move toward the right opportunities with a smarter strategy.
            </p>
...
function PainPointsSection({ onCTA }: { onCTA: () => void }) {
  return (
    <Sec id="solution" bg="white" className="!pb-5 sm:!pb-6">
      <SecHead
        eyebrow="Where You May Be Stuck"
        title="Stop Guessing. Start Moving Smarter."
        sub="More applications do not always mean more progress. The key is knowing whether the real gap is your target list, resume, experience, interview skills, or timeline."
        center
      />
...
const ACTION_PATH_STEPS = [
  { n: '01', title: 'Role Targeting', desc: 'Identify the most strategic roles to pursue based on your background, stage, visa timeline, and target industry.' },
  { n: '02', title: 'Profile & Resume Upgrade', desc: 'Turn coursework, projects, research, and campus experience into application materials that support target roles.' },
  { n: '03', title: 'Applications & Interview Prep', desc: 'Set weekly action items and prepare project stories, behavioral answers, and role motivation.' },
  { n: '04', title: 'Long-Term Career Planning', desc: 'Plan ahead across internships, full-time roles, CPT/OPT, and long-term career growth.' },
];
      ...
      <div className="grid items-stretch gap-4 lg:grid-cols-[0.9fr_1.1fr] lg:gap-8">
        ...
        >
          ...
          <h2 className="text-[36px] font-semibold leading-[1.12] tracking-[-0.045em] sm:text-[46px]" style={{ color: INK }}>
            Turn <span style={{ color: GREEN }}>Job-Search Anxiety</span>  Into a Clear Action Plan.
          </h2>
          <p className="mt-5 max-w-md text-[14px] font-medium leading-7 sm:text-[15px]" style={{ color: INK_MUTED }}>
            Better outcomes come from sharper priorities. MentorX helps you decide whether to build experience, improve materials, narrow your targets, or move directly into applications and interview prep.
          </p>
          <button
            type="button"
            onClick={onCTA}
        ...
        <div className="order-1 lg:order-2">
          <div className="mb-5">
            ...
            <h2 className="text-[34px] sm:text-[40px] font-semibold mb-3 leading-tight" style={{ color: INK, letterSpacing: '-0.03em' }}>
              Guided Through the Full Job-Search Cycle,<br />From Planning to Offer
            </h2>
...
function MentorSection({ onCTA }: { onCTA: () => void }) {
  ...
  return (
    <section id="mentors" className="py-14 overflow-hidden" style={{ background: 'white' }}>
      {/* Header — constrained */}
      <div className="max-w-6xl mx-auto px-5 sm:px-8 mb-6">
        <SecHead
          eyebrow="Top Mentor Team"
          title="Prepare With People Who Truly Understand the Industry"
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex flex-col items-center text-center mb-6 [&>div]:mb-0">
          <SecHead
            ...
            title="Real Feedback From Students Who Moved Forward"
            sub="More than 3,000 students received exciting offers within a month. They were once uncertain and anxious too, but when the path became clear and action continued, results started to happen."
            center
          />
        </div>
...
const BRAND_CARDS = [
  ...
  {
    number: 'Offer',
    title: 'From Application to Result',
  ...
  return (
    <Sec bg="white" id="aboutus">
      <div className="text-center mb-8">
        <SecHead
            eyebrow="Why MentorX"
            title={<>Better Strategy. Higher Response. Stronger Offers.</>}
            sub="MentorX supports international students across internships, full-time recruiting, OPT/CPT planning, and career pivots, combining mentor expertise, real outcomes, and job-market data to turn preparation into action."
            center
          />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-[1fr_auto] gap-8 items-center">
          <div>
            ...
            <h2 className="text-[32px] sm:text-[42px] lg:text-[48px] font-semibold leading-tight mb-4" style={{ color: INK, letterSpacing: '-0.03em' }}>
              Don’t Wait Until 
             <span className="whitespace-nowrap" style={{ color: GREEN }}> Graduation.</span>
            </h2>
            <p className="text-[15px] mb-0 max-w-xl leading-relaxed md:mb-6" style={{ color: INK_MUTED }}>
              Not sure which roles to target? Getting no response from applications? Worried about your OPT timeline? Start with a free career review and identify the next move that matters most.
            </p>
            <button
              onClick={onCTA}
...
export function LandingPage() {
  ...
  return (
    <div className="overflow-x-hidden" style={{ background: CANVAS, fontFamily: "'Plus Jakarta Sans', system-ui, -apple-system, BlinkMacSystemFont, 'PingFang SC', 'Microsoft YaHei', 'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <NavBar onCTA={open} langHref="/general-job-coaching" langLabel="中文" ctaLabel="Book a Free Consultation" />
