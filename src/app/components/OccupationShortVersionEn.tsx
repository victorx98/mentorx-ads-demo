...
const PAIN_POINTS = [
  {
    n: '01', title: '	Not Sure Which Roles Fit?',
    desc: 'Your major gives you options, but the right career direction still feels unclear.',
    solution: '	Identify high-fit industries, roles, and priorities based on your background and goals.',
  },
  {
    n: '02', title: 'Want to Pivot, but Missing Experience?',
    desc: 'You want to move into a new field, but your resume does not yet show the right proof.',
    solution: 'Build a focused experience plan with projects, skills, and profile upgrades that support your target path.',
  },
  {
    n: '03', title: 'Your Experience Doesn’t Stand Out Yet',
    desc: 'You have coursework and projects, but the story is not strong enough for recruiters to see the fit.',
    solution: 'Reframe your experience into sharper resume bullets, stronger project stories, and clearer role alignment.',
  },
  {
    n: '04', title: 'Application Direction Is Too Scattered',
    desc: 'You are applying across too many industries and roles without clear priorities, making feedback inconsistent.',
    solution: 'We set role priorities and an application rhythm so the process becomes more focused and easier to review.',
  },
  {
    n: '05', title: 'Target Roles Have High Requirements',
    desc: 'You do not fully understand hiring standards, skill expectations, or interview logic for target roles.',
    solution: 'Industry mentor feedback helps students understand real role requirements and prepare more precisely.',
  },
  {
    n: '06', title: 'Tight Authorization Timeline',
    desc: 'CPT, OPT, and H-1B windows require earlier planning.',
    solution: 'Plan internship, full-time, and H-1B priorities around graduation and work authorization status.',
  },
];
...
const MAJOR_PATHS = [
  {
    ...
    stats: ["3,200+ Student Outcomes", "86 Mentors"],
    tags: ["Finance", "Accounting", "Economics", "Marketing", "Business Analytics"],
    roles: "Financial analysis, business analysis, consulting, marketing strategy, supply chain, operations",
    support: "Finance, consulting, and business analysis mentor support",
  },
  {
    area: "Technology & Data",
    stats: ["4,800+ Student Outcomes", "124 Mentors"],
    tags: ["CS", "Data Science", "Information Systems", "HCI"],
    roles: "SDE、Data Analyst、Product Manager、UX Research、Cybersecurity",
    support: "Cases across technology, data, and product paths",
  },
  {
    area: "Engineering & Manufacturing",
    stats: ["1,900+ Student Outcomes", "52 Mentors"],
    tags: ["Mechanical", "Electrical", "Civil", "Industrial", "Biomedical Engineering"],
    roles: "Engineering roles, project management, manufacturing, energy, medical devices, technical consulting",
    support: "Engineering, manufacturing, and technical consulting path support",
  },
  {
    area: "Media & Social Sciences",
    stats: ["1,400+ Student Outcomes", "38 Mentors"],
    tags: ["Communication", "Psychology", "Education", "Public Policy", "Media"],
    roles: "Marketing, PR, user research, edtech, policy research, HR",
    support: "Marketing, PR, and user research mentor support",
  },
  {
    area: "Life Sciences & Health",
    stats: ["1,100+ Student Outcomes", "31 Mentors"],
    tags: ["Biology", "Chemistry", "Public Health", "Statistics", "Math"],
    roles: "Biopharma, healthcare consulting, research assistant roles, data analysis, healthcare business",
    support: "Healthcare and research-to-business case references",
  },
  {
    area: "Art, Design & Creative",
    stats: ["820+ Student Outcomes", "27 Mentors"],
    tags: ["Design", "HCI", "Architecture", "Fashion", "Creative"],
    roles: "UX/UI, brand design, creative marketing, architecture, fashion management",
    support: "Portfolio, design career, and creative role support",
  },
];
...
const MAJOR_RESOURCES = [
  {
    ...
    desc: "Covering tech, finance, consulting, data, product, marketing, engineering, healthcare, and more.",
  },
  {
    title: "Case Library",
    desc: "Real paths from internship applications to full-time search and career pivots across majors.",
  },
  {
    title: "Role Data",
    desc: "Role requirements, skill keywords, and application trends help students choose a better-fit direction.",
  },
];
    ...
    <section style={{ background: CANVAS }}>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-6 pb-5 lg:pt-8 lg:pb-6">
        <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(250px,0.78fr)] md:gap-7 lg:grid-cols-[minmax(0,1fr)_minmax(300px,0.78fr)] lg:gap-8 items-center min-w-0">
          ...
          <div className="order-1 min-w-0" style={{ maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)' }}>
            ...
            >
             Career Planning for Every Major
            </div>
            ...
            >
              <span className="whitespace-nowrap">Different Academic Backgrounds,</span><br />
              <span className="whitespace-nowrap">Can Still Lead to Better-Fit Career Paths</span>
            </h1>
            ...
            <h1
              ...
              style={{ color: INK, letterSpacing: '-0.04em', maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)', wordBreak: 'keep-all', overflowWrap: 'normal' }}
            >
          	Turn Your Major Into <span className="whitespace-nowrap" style={{ color: GREEN }}>Job-Search Advantages.</span>
            </h1>
            ...
            <p className="hidden text-[16px] leading-relaxed mb-4 max-w-[19rem] sm:max-w-md md:block" style={{ color: INK_MUTED, overflowWrap: 'anywhere' }}>
              From business and social sciences to tech, engineering, and design, MentorX helps you turn your major into a stronger career path.
            </p>
            ...
            <div className="grid grid-cols-3 gap-2 text-[10px] text-gray-500 sm:flex sm:flex-wrap sm:items-center sm:justify-start sm:gap-6 sm:text-[15px]">
              {['11+ Years of Expertise', '33,000+ Students', '95% Success Rate'].map(t => (
                <div
                  key={t}
          ...
          <div className="order-2 hidden justify-center md:flex md:justify-end min-w-0">
            <div className="relative w-full max-w-[320px] sm:max-w-[340px] md:w-[clamp(260px,30vw,360px)] md:max-w-none rounded-[16px]" style={{ boxShadow: '0 16px 48px rgba(17,24,39,0.08)' }}>
              ...
              />
              <Badge text="OPT/H-1B Career Path Guidance" className="bottom-[18%] left-0 sm:-left-8" style={heroTagStyle(24, -2.05)} />
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pb-4">
        <div className="flex items-center gap-2 text-[13px] font-medium mb-4" style={{ color: '#6b9e86' }}>
          Connecting universities, employers, and industry mentor resources
        </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-5 rounded-[16px] border bg-white p-5 sm:p-6" style={{ borderColor: HAIRLINE, boxShadow: '0 14px 44px rgba(17,24,39,0.06)' }}>
          ...
          <div className="rounded-[12px] p-5 text-white" style={{ background: GREEN_DARK }}>
            ...
            <p className="mb-0 text-[14px] leading-relaxed text-white/70 md:mb-5">A simple entry point for consultation: users do not need to understand every service first. They share their intent, and the assessment guides the next step.</p>
            <button
              onClick={onCTA}
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="text-center mb-10">
          <SecHead
            ...
            title="11+ Years Helping International Students Take the First Career Step"
            center
            />
        </div>
...
function PainPointsSection({ onCTA }: { onCTA: () => void }) {
  return (
    <Sec id="solution" bg="white">
      <SecHead
        eyebrow="Where You May Be Stuck"
        title={<>Your Major Is Not the Problem. <span className="whitespace-nowrap"><span style={{ color: GREEN }}>Positioning Is.</span></span></>}
        sub="Every major can lead somewhere strong. The real advantage comes from knowing which roles to target, what experience to build, and how to translate your background into employer-ready value."
        center
      />
...
const ACTION_PATH_STEPS = [
  { n: '01', title: 'Major-to-Role Fit', desc: 'Match your major, interests, and timeline with roles that make strategic sense.' },
  { n: '02', title: 'Gap Review', desc: '	Identify the resume, project, skill, and experience gaps holding you back.' },
  { n: '03', title: 'Profile Upgrade', desc: 'Turn coursework, projects, and past experience into stronger career proof.' },
  { n: '04', title: 'Career Roadmap', desc: 'Build a realistic path across internships, full-time roles, and visa timelines.' },
];
      ...
      <div className="grid items-stretch gap-4 lg:grid-cols-[0.9fr_1.1fr] lg:gap-8">
        ...
        >
          ...
          <h2 className="text-[36px] font-semibold leading-[1.12] tracking-[-0.045em] sm:text-[46px]" style={{ color: INK }}>
            Turn Your Major Into a  <span style={{ color: GREEN }}>“Career Move”</span>
          </h2>
          <p className="mt-5 max-w-md text-[14px] font-medium leading-7 sm:text-[15px]" style={{ color: INK_MUTED }}>
           More information won’t fix a stalled job search. A clearer plan will. MentorX helps you decide where to go, what to build, and how to move next.
          </p>
          <button
            type="button"
            onClick={onCTA}
...
function MajorPathSection({ onCTA }: { onCTA: () => void }) {
  ...
  return (
    <Sec bg={CANVAS}>
      <SecHead
        eyebrow="Major Coverage"
        title="Start From Your Major and Find a Better-Fit Career Path"
        sub="Students from different majors need different role directions, experience building, and preparation. MentorX combines mentors, real cases, and role data to turn academic background into career competitiveness."
        center
      />
      ...
      >
            ...
            return (
              ...
              >
                ...
                <div className="mt-auto">
                  <div className="mb-1.5 text-[12px] font-medium" style={{ color: "#8A938D" }}>Possible Role Directions</div>
        ...
        <button
          type="button"
          aria-label="Previous major direction"
        ...
        <button
          type="button"
          aria-label="Next major direction"
          onClick={() => moveTo(activeIndex + 1)}
      ...
      <div className="mt-14 text-center">
        <h3 className="text-[16px] font-semibold" style={{ color: INK }}>Every Direction Comes With Relevant Resources</h3>
      ...
      <div className="hidden text-center mt-10 md:block">
        <Btn label="Assess My Major Direction" onClick={onCTA} size="lg" />
      </div>
    </Sec>
  );
}
        ...
        <div className="order-1 lg:order-2">
          <div className="mb-8">
            ...
            <h2 className="text-[34px] sm:text-[40px] font-semibold mb-3 leading-tight" style={{ color: INK, letterSpacing: '-0.03em' }}>
              From Academic Background to Career Direction,<br />Every Step Has Clear Judgment
            </h2>
            <p className="text-[14px] leading-relaxed" style={{ color: INK_MUTED }}>
              Structured, personalized, and data-informed guidance for your career growth path.
            </p>
          </div>
  ...
  return (
    <section id="mentors" className="py-20 overflow-hidden" style={{ background: 'white' }}>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 mb-10">
        <SecHead
          eyebrow="Top Mentor Team"
          title="Let People Who Understand Majors and Industries Help You Judge Direction"
          sub="Mentors come from tech, finance, consulting, data, and other mainstream industries, matched to student target roles."
          center
        />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex flex-col items-center text-center mb-8 [&>div]:mb-0">
          <SecHead
            ...
            title="Different Academic Backgrounds Can Still Build Career Paths Worth Learning From"
            sub="From business to consulting and finance, CS to product and data, social sciences to marketing and PR, and life sciences to healthcare and business roles, every transition depends on clear planning, targeted preparation, and continuous feedback."
            center
          />
        </div>
...
const BRAND_CARDS = [
  {
    number: '4200+',
    title: 'Employer & Internship Resources',
    desc: 'Opportunities across tech, finance, consulting, engineering, media, data, and more.',
  },
  {
    number: '11+ yrs',
    title: 'Supporting Global Students',
    desc: 'Built around the career, visa, and timing challenges international students face.',
  },
  {
    number: '1:1',
    title: 'Industry Mentor Coaching',
    desc: 'Resume, project, and interview coaching aligned with your target role.',
  },
  {
    number: 'Offer',
    title: 'From Major to Offer',
    desc: 'Not just direction. A step-by-step path toward real outcomes.',
  },
];
  ...
  return (
    <Sec bg="white" id="aboutus">
      <div className="text-center mb-8">
        <SecHead
            eyebrow="Why MentorX?"
            title={<>Your Major Is Not the Limits. <span className="whitespace-nowrap" style={{ color: GREEN }}>Your Strategy </span>Is the Multiplier</>}
            sub="MentorX helps students translate academic backgrounds into stronger role targeting, sharper materials, and a more competitive job-search strategy."
            center
          />
      </div>
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-6 lg:gap-10 items-center">
          <div>
            ...
            <h2 className="text-[32px] sm:text-[42px] lg:text-[48px] font-semibold leading-tight mb-5" style={{ color: INK, letterSpacing: '-0.03em' }}>
              Not Sure <span className="whitespace-nowrap" style={{ color: GREEN }}>Where Your Major Can Take You?</span><br />
              <span style={{ color: GREEN_DARK }}></span>
            </h2>
            <p className="text-[15px] mb-0 max-w-xl leading-relaxed md:mb-9" style={{ color: INK_MUTED }}>
              Whether you are looking for internships, full-time roles, or considering a major or industry pivot, start with a free direction assessment to clarify the most suitable path.
            </p>
            <button
              onClick={onCTA}
...
export function Occupation() {
  ...
  return (
    <div className="overflow-x-hidden" style={{ background: CANVAS, fontFamily: "'Plus Jakarta Sans', 'Noto Sans SC', system-ui, -apple-system, sans-serif" }}>
      ...
      <NavBar onCTA={open} langHref="/occupation-short-version" langLabel="中文" ctaLabel="Book a Free Consultation" />
