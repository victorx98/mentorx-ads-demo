...
const PAIN_POINTS = [
  {
    n: '01', title: 'Unclear Internship Direction',
    desc: 'Too many options, not enough clarity on which roles fit your major, interests, and long-term goals.',
    solution: 'Define high-fit internship tracks and application priorities based on your background, major, and target industry.',
  },
  {
    n: '02', title: 'Limited Relevant Experience',
    desc: 'You want stronger internships, but your resume does not yet show the projects, skills, or practical experience employers expect.',
    solution: 'We plan project building, skill development, and background improvement around the requirements of your target roles.',
  },
  {
    n: '03', title: 'Resume Not Professional Enough',
    desc: 'You may have experience, but your resume does not quickly communicate role fit or measurable value.',
    solution: 'We refine resume structure, keywords, and achievement framing so your experience fits internship role expectations.',
  },
  {
    n: '04', title: 'Confusing Internship Timeline',
    desc: 'You are not sure when to prepare, when to apply, or which windows cannot be missed.',
    solution: 'We build a clear internship application timeline based on your target region, industry, and school year.',
  },
  {
    n: '05', title: 'Not Enough Interview Practice',
    desc: 'You are unsure how to explain projects, experience, behavioral stories, and role-related questions.',
    solution: 'Mock interviews and mentor feedback help improve logic, story clarity, and role match.',
  },
  {
    n: '06', title: 'Experience Not Turning Into Advantage',
    desc: 'Projects or internships exist, but it is unclear how to turn them into a stronger profile for future roles.',
    solution: 'We help review outcomes, extract achievements, and turn experience into stronger resume and interview evidence.',
  },
];
    ...
    <section style={{ background: CANVAS }}>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-8 pb-6 lg:pt-12 lg:pb-8">
        <div className="grid lg:grid-cols-[1fr_1fr] gap-8 lg:gap-8 items-center min-w-0">
          ...
          <div className="order-1 min-w-0" style={{ maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)' }}>
            ...
            >
              Build the Experience That Opens Doors
            </h1>
            ...
            <p className="hidden text-[17px] leading-relaxed mb-5 max-w-[19rem] sm:max-w-md md:block" style={{ color: INK_MUTED, overflowWrap: 'anywhere' }}>
              MentorX helps international students target the right internships, strengthen their profiles, and build experience that supports future full-time recruiting.
            </p>
            ...
            <div className="grid grid-cols-3 gap-2 text-[10px] text-gray-500 sm:flex sm:flex-wrap sm:items-center sm:justify-start sm:gap-6 sm:text-[15px]">
              {['Stage-based planning', 'Multi-industry paths', 'Profile-building'].map(t => (
                <div
                  key={t}
          ...
          <div className="order-2 flex justify-center lg:justify-end min-w-0">
            <div className="relative w-full max-w-[350px] sm:max-w-[380px] lg:max-w-[420px] rounded-[16px]" style={{ boxShadow: '0 16px 48px rgba(17,24,39,0.08)' }}>
              ...
              {/* Floating badges */}
              <Badge text="11+ years experience" className="-top-3 left-0 sm:-left-8" style={heroTagStyle(-28, -0.15)} />
              <Badge
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pb-6">
        <div className="flex items-center gap-2 text-[13px] font-medium mb-4" style={{ color: '#6b9e86' }}>
          Student internship and career outcomes across industries
        </div>
  ...
  return (
    <Sec id="solution" bg="white">
      <SecHead
        ...
        title="From Unclear Options to a Stronger Internship Plan"
        sub="MentorX combines your major, target industry, and career goals to clarify which internships to pursue, how to prepare, and how to turn experience into competitiveness."
        center
      />
...
const FLOW_STEPS_NEW = [
  { n: '01', title: 'Goal Setting', desc: '	Clarify target markets, industries, roles, and recruiting timelines.' },
  { n: '02', title: 'Gap Analysis', desc: '	Identify gaps across resume, skills, projects, and interview readiness.' },
  { n: '03', title: 'Application Roadmap', desc: 'Build a staged plan for learning, projects, and applications.' },
  { n: '04', title: 'Career Training', desc: 'Strengthen competitiveness through training, projects, and mentor coaching.' },
  { n: '05', title: '	Readiness Check', desc: 'Track readiness and adjust the strategy as you progress.' },
        ...
        <div className="order-1 lg:order-2">
          <div className="mb-8">
            ...
            <h2 className="text-[30px] sm:text-[34px] font-semibold mb-3 leading-tight" style={{ color: INK, letterSpacing: '-0.03em' }}>
              From Profile Review to Internship Readiness
            </h2>
            <p className="text-[14px] leading-relaxed" style={{ color: INK_MUTED }}>
              We help you choose the right direction, build stronger experience, sharpen your materials, and turn each step into long-term career value.
            </p>
          </div>
    ...
    <section id="mentors" className="py-10 md:py-14 overflow-hidden" style={{ background: 'white' }}>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 mb-8">
        <SecHead
          ...
          title="Build Internship Experience With People Who Know the Industry"
          sub="Mentors come from tech, finance, consulting, data, and other major fields, helping students understand what internship roles actually require."
          center
        />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex flex-col items-center text-center mb-8 [&>div]:mb-0">
          <SecHead
            ...
            title="Real Internships. Real Career Momentum."
            sub="From no relevant experience to a first internship, and from a thin resume to stronger opportunities, MentorX helps students turn preparation into measurable career momentum."
            center
          />
        </div>
    ...
    <Sec bg="white" id="aboutus" className="!py-14 sm:!py-16">
      <div className="text-center mb-8">
        <SecHead
            ...
            title="Real Insight. Smarter Career Moves."
            sub=" MentorX combines market data, AI analysis, and mentor expertise to help students move from uncertainty to a clear, actionable career plan."
            center
          />
      </div>
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-6 lg:gap-10 items-center">
          <div>
            ...
            <h2 className="text-[28px] sm:text-[36px] lg:text-[42px] font-semibold leading-tight mb-5" style={{ color: INK, letterSpacing: '-0.03em' }}>
              Looking for an internship but not sure where to start?
            </h2>
            <p className="text-[15px] mb-0 max-w-xl leading-relaxed md:mb-9" style={{ color: INK_MUTED }}>
              Not sure which internships to apply for? Missing relevant experience? Worried about missing the summer timeline? Start with a free background assessment to clarify your next step.
            </p>
            <button
              onClick={onCTA}
