...
const PAIN_POINTS = [
  {
    n: '01', title: 'Unclear Priorities',
    desc: 'You have limited time, but you are still unsure which roles are worth applying to first..',
    solution: 'We evaluate your background, target location, and job-search stage to identify high-fit roles and set the right application priority.',
  },
  {
    n: '02', title: 'Work Authorization Pressure',
    desc: 'CPT, OPT, Grace Period, and H-1B timelines directly affect your choices. Planning late means fewer options.',
    solution: 'We work backward from key authorization deadlines to build a safer, more realistic application rhythm.',
  },
  {
    n: '03', title: 'Low Resume Response',
    desc: 'Your resume may not clearly show role fit or the ability to contribute immediately, causing applications to go unanswered.',
    solution: 'We rebuild your resume around target roles, highlighting transferable skills, project impact, and keyword alignment.',
  },
  {
    n: '04', title: 'Slow Application Progress',
    desc: 'You are applying broadly without a clear priority list, making it hard to improve response rates or learn from feedback.',
    solution: 'We build a focused role list, set an application cadence, and use referrals and review cycles to improve conversion.',
  },
  {
    n: '05', title: 'Interview Prep Gaps',
    desc: 'You may already have interviews, but your project stories, behavioral answers, and role-specific responses are not ready.',
    solution: 'Industry mentors run mock interviews and help you sharpen project storytelling, behavioral answers, and role-specific frameworks.',
  },
  {
    n: '06', title: 'Unclear Offer Progress',
    desc: 'After interviews, it can be hard to know how to follow up, review performance, or adjust your next move.',
    solution: 'We help review interview performance, refine follow-up strategy, and adjust preparation for the next round or offer stage.',
  },
];
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-8 pb-6 lg:pt-12 lg:pb-8">
        <div className="grid lg:grid-cols-[1fr_1fr] gap-8 lg:gap-8 items-center min-w-0">
          ...
          <div className="order-1 min-w-0" style={{ maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)' }}>
            ...
            >
              Move Faster Before Your Timeline Runs Out
            ...
            <p className="hidden text-[17px] leading-relaxed mb-5 max-w-[19rem] sm:max-w-md md:block" style={{ color: INK_MUTED, overflowWrap: 'anywhere' }}>
             Built for CPT and OPT students who need a clear path, stronger materials, faster interviews, and a smarter job-search strategy around work-authorization deadlines.
            </p>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-5 rounded-[16px] border bg-white p-5 sm:p-6" style={{ borderColor: HAIRLINE, boxShadow: '0 14px 44px rgba(17,24,39,0.06)' }}>
          ...
          <div className="rounded-[12px] p-5 text-white" style={{ background: GREEN_DARK }}>
            ...
            <p className="mb-5 text-[14px] leading-relaxed text-white/70">A simple consultation entry point: students do not need to understand every service first; the assessment helps turn interest into the right plan.</p>
            <button
              onClick={onCTA}
  ...
  return (
    <Sec id="solution" bg="white">
      <SecHead
        ...
        title="OPT Timeline. Real Pressure. Smarter Moves."
        sub="For CPT and OPT students, every decision matters. MentorX helps you focus on the steps that can move you closer to an offer."
        center
      />
...
const FLOW_STEPS_NEW = [
  { n: '01', title: 'Set Targets', desc: 'Clarify target roles, locations, industries, and your OPT/CPT timeline.' },
  { n: '02', title: 'Gap Analysis', desc: 'Identify resume, skill, project, and interview gaps that affect conversion.' },
  { n: '03', title: 'Application Plan', desc: 'Create a focused target list, application rhythm, and referral strategy.' },
  { n: '04', title: 'Interview Training', desc: 'Practice technical, behavioral, and role-specific interview responses.' },
  { n: '05', title: 'Progress Review', desc: 'Review outcomes and adjust priorities as new feedback comes in.' },
  { n: '06', title: 'Offer Support', desc: 'Plan next steps around offers, work authorization, and full-time goals.' },
];
        ...
        <div className="order-1 lg:order-2">
          <div className="mb-8">
            ...
            <h2 className="text-[30px] sm:text-[34px] font-semibold mb-3 leading-tight" style={{ color: INK, letterSpacing: '-0.03em' }}>
              From Plan to Offer, With Momentum
            </h2>
            <p className="text-[14px] leading-relaxed" style={{ color: INK_MUTED }}>
              Plan around key OPT/CPT milestones, clarify direction, improve materials, build an application strategy, and keep adjusting through interviews and offer progress.
            </p>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex flex-col items-center text-center mb-8 [&>div]:mb-0">
          <SecHead
            ...
            sub="With the right strategy, mentor guidance, and consistent execution, students can move from uncertainty and low response rates to clearer direction, stronger interviews, and real offers."
            center
          />
        </div>
...
const BRAND_CARDS = [
  {
    ...
    desc: 'Plan around CPT, OPT, graduation, and target roles to identify the best path forward.',
  },
  {
    number: '02',
    label: 'AI Matching',
    title: 'Smarter Matching',
    desc: 'Use AI insights and mentor experience to pinpoint resume, role-fit, and interview gaps faster.',
  },
  {
    number: '03',
    label: 'Expert Support',
    title: '	Offer Momentum',
    desc: 'Advisors and mentors track applications, interviews, and offer stages to help students move faster within limited time.',
  },
];
    ...
    <Sec bg="white" id="aboutus" className="!py-14 sm:!py-16">
      <div className="text-center mb-8">
        <SecHead
            ...
            title="Clearer Direction. Stronger Outcomes."
            sub="MentorX combines student cases, role data, AI analysis, and industry mentor experience to help OPT/CPT students understand their gaps, build a timeline-aware strategy, and move each step toward results."
            center
          />
      </div>
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-6 lg:gap-10 items-center">
          <div>
            ...
            <h2 className="text-[28px] sm:text-[36px] lg:text-[42px] font-semibold leading-tight mb-5" style={{ color: INK, letterSpacing: '-0.03em' }}>
              OPT Timeline Getting Tight? <br></br>Get a Clear Next Step.
            </h2>
            <p className="text-[15px] mb-0 max-w-xl leading-relaxed md:mb-9" style={{ color: INK_MUTED }}>
              Not sure which roles to target? No resume responses? Worried about OPT timing? Start with a free assessment to identify what to fix first and how to move forward.
            </p>
            <button
              onClick={onCTA}
