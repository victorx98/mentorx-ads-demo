...
const PAIN_POINTS = [
  {
    ...
    desc: 'You have limited time, but are still unsure which roles are worth applying to first.',
    solution: 'We evaluate role resources, academic background, and work authorization context to identify roles worth prioritizing now.',
  },
  {
    n: '02', title: 'Work Authorization Pressure',
    desc: 'CPT, OPT, grace period, and H-1B timelines can directly affect your job-search options.',
  ...
  },
  {
    ...
    desc: 'Your resume does not clearly show role fit or job-ready skills, leading to weak response rates.',
    solution: 'We rebuild your resume around target roles, project impact, and role-fit signals to improve screening conversion.',
  },
  {
    n: '04', title: 'Slow Application Progress',
    desc: 'You are applying without a clear target list, timing, or priority system.',
  ...
  {
    n: '05', title: 'Not Enough Interview Time',
    desc: 'Interviews are coming, but your project stories, behavioral answers, and role motivation are not ready.',
    solution: 'We match you with industry mentors for focused mock interviews and stronger project, behavioral, and role-specific answers.',
  },
  {
    n: '06', title: 'Uncertain Offer Progress',
    desc: 'After interviews, you are unsure how to follow up, review performance, or adjust strategy.',
    solution: 'We review interview performance, refine follow-up strategy, and adjust preparation for the next round.',
  },
];
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-6 pb-5 lg:pt-8 lg:pb-6">
        <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(250px,0.78fr)] md:gap-7 lg:grid-cols-[minmax(0,1fr)_minmax(300px,0.78fr)] lg:gap-8 items-center min-w-0">
          ...
          <div className="order-1 min-w-0" style={{ maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)' }}>
            ...
            >
              OPT Clock Ticking?<br></br><span className="whitespace-nowrap"> <span style={{ color: GREEN }}>Don’t Job Hunt Alone.</span></span>
            ...
            <p className="hidden text-[16px] leading-relaxed mb-4 max-w-[19rem] sm:max-w-md md:block" style={{ color: INK_MUTED, overflowWrap: 'anywhere' }}>
             Built for CPT and OPT students who need sharper direction, stronger materials, faster interviews, and a job-search plan that respects the visa timeline.
            </p>
            ...
            <div className="grid grid-cols-3 gap-2 text-[10px] text-gray-500 sm:flex sm:flex-wrap sm:items-center sm:justify-start sm:gap-6 sm:text-[15px]">
              {['4,200+ Role Resources', '33,000+ Students', '95% Success Rate'].map(t => (
                <div
                  key={t}
...
function PainPointsSection({ onCTA }: { onCTA: () => void }) {
  return (
    <Sec id="solution" bg="white">
      <SecHead
        eyebrow="Where Students Get Stuck"
        title="	Tight Timeline. Smarter Moves."
        sub="With CPT or OPT, every week matters. Direction, role fit, application speed, and interview readiness all shape how quickly you can move toward the right offer."
        center
      />
...
const ACTION_PATH_STEPS = [
  { n: '01', title: 'Timeline Review', desc: 'Review your CPT/OPT status, graduation timing, and recruiting window to identify the best next move.' },
  { n: '02', title: '	Role Fit & Resume Upgrade', desc: 'Align your resume, projects, and keywords with the roles you are targeting.' },
  { n: '03', title: '	Application & Interview Sprint', desc: 'Set a weekly execution rhythm and prepare project stories, behavioral answers, and role motivation.' },
  { n: '04', title: 'Offer and Long-Term Career Planning', desc: 'Plan across internships, full-time roles, and H-1B timing for a stronger career path.' },
];
      ...
      <div className="grid items-stretch gap-4 lg:grid-cols-[0.9fr_1.1fr] lg:gap-8">
        ...
        >
          ...
          <h2 className="text-[36px] font-semibold leading-[1.12] tracking-[-0.045em] sm:text-[46px]" style={{ color: INK }}>
            Turn <span style={{ color: GREEN }}> Urgency </span> Into a Clear Job-Search Plan 
          </h2>
          <p className="mt-5 max-w-md text-[14px] font-medium leading-7 sm:text-[15px]" style={{ color: INK_MUTED }}>
            Faster progress starts with sharper priorities. MentorX helps you decide whether to fix your resume, narrow your targets, or move straight into interview prep.
          </p>
          <button
            type="button"
            onClick={onCTA}
        ...
        <div className="order-1 lg:order-2">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 mb-3 text-[13px] font-medium tracking-[0.04em]" style={{ color: GREEN }}>
              <span>—</span>
              Fast Career Launch Path
              <span>—</span>
            </div>
            <h2 className="text-[34px] sm:text-[40px] font-semibold mb-3 leading-tight" style={{ color: INK, letterSpacing: '-0.03em' }}>
              Move From Planning to Offer Faster and More Steadily
            </h2>
            <p className="text-[14px] leading-relaxed" style={{ color: INK_MUTED }}>
              Around OPT/CPT milestones, we clarify direction, optimize materials, set application strategy, and adjust interview and offer execution.
            </p>
          </div>
    ...
    <section id="mentors" className="py-20 overflow-hidden" style={{ background: 'white' }}>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 mb-10">
        <SecHead
          ...
          title="Work With Mentors Who Understand Hiring Timelines"
          sub="MentorX mentors come from technology, finance, consulting, data, product, and other high-demand fields. They understand hiring standards and the real pressure international students face around timelines, role selection, and interviews."
          center
        />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex flex-col items-center text-center mb-8 [&>div]:mb-0">
          <SecHead
            ...
            title="Behind Every Offer Is a Path Worth Learning From"
            sub="From graduation anxiety to internship or full-time opportunities, and from no responses to clearer direction, stronger strategy, and interview progress, effective outcomes come from clear judgment, fast action, and continuous adjustment."
            center
          />
        </div>
...
const BRAND_CARDS = [
  ...
  },
  {
    ...
    desc: 'We do more than review resumes. We help move interviews forward, review feedback, and judge next opportunities.',
  },
];
  ...
  return (
    <Sec bg="white" id="aboutus">
      <div className="text-center mb-8">
        <SecHead
            eyebrow="Why MentorX？"
            title="From Timeline Pressure to Offer Progress"
            sub="MentorX combines student outcomes, role data, AI analysis, and mentor expertise to help CPT and OPT students make smarter decisions and move faster toward interviews and offers."
            center
          />
      </div>
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-6 lg:gap-10 items-center">
          <div>
            ...
            <h2 className="text-[32px] sm:text-[42px] lg:text-[48px] font-semibold leading-tight mb-5" style={{ color: INK, letterSpacing: '-0.03em' }}>
              <span style={{ color: GREEN }}>OPT/CPT Timeline Getting Tight?</span><br></br>Know Your Next Move.
            </h2>
            <p className="text-[15px] mb-0 max-w-xl leading-relaxed md:mb-9" style={{ color: INK_MUTED }}>
              Not sure which roles to apply for? No resume response? Worried about the OPT timeline? Start with a free assessment to clarify what to optimize first.
            </p>
            <button
              onClick={onCTA}
...
export function OPT() {
  ...
  return (
    <div className="overflow-x-hidden" style={{ background: CANVAS, fontFamily: "'Plus Jakarta Sans', system-ui, -apple-system, BlinkMacSystemFont, 'PingFang SC', 'Microsoft YaHei', 'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <NavBar onCTA={open} langHref="/opt-short-version" langLabel="中文" ctaLabel="Book a Free Consultation" />
