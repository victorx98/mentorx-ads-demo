...
const PAIN_POINTS = [
  {
    n: '01', title: 'Unclear Career Direction',
    desc: 'You know your major, but not which roles, industries, or career paths actually fit after graduation.',
    solution: 'We map your major, strengths, and market demand to define target industries, roles, and application priorities.',
  },
  {
    n: '02', title: 'Pivoting Without the Right Experience',
    desc: 'You want to move into data, product, consulting, marketing, or finance, but are unsure what skills, projects, or experience to build.',
    solution: 'We work backward from target roles to identify the skills, projects, and experience needed for a credible pivot.',
  },
  {
    n: '03', title: 'Weak Resume Positioning',
    desc: 'Courses, papers, projects, and internships exist, but your resume does not connect them clearly to target roles.',
    solution: 'We translate academic experience into role-ready language, with sharper impact, keywords, and resume structure.',
  },
  {
    n: '04', title: 'Scattered Applications',
    desc: 'You are applying across too many roles and industries without a clear priority system.',
    solution: 'We build role priorities and application rhythm so your search becomes focused, measurable, and easier to adjust.',
  },
  {
    n: '05', title: '	Higher Hiring Bar',
    desc: 'You do not fully understand what target roles expect, what skills matter, or how interviews are evaluated.',
    solution: 'Industry mentors help you understand real hiring standards and prepare materials and interviews more precisely.',
  },
  {
    n: '06', title: 'Visa and Timeline Pressure',
    desc: 'CPT, OPT, and H-1B windows require early planning around internships, full-time roles, and sponsorship.',
    solution: 'We plan internships, full-time search, and H-1B priorities around graduation and work authorization timelines.',
  },
];

const MAJOR_PATHS = [
  { area: 'Business & Finance', stats: ['3,200+ offers', '86 mentors'], tags: ['Finance', 'Accounting', 'Economics', 'Marketing', 'Business Analytics'], roles: 'Financial analysis, business analysis, consulting, market strategy, supply chain, operations', support: 'Finance, consulting, and business analytics mentor support' },
  { area: 'Technology & Data', stats: ['4,800+ offers', '124 mentors'], tags: ['CS', 'Data Science', 'Information Systems', 'HCI'], roles: 'SDE, Data Analyst, Product Manager, UX Research, Cybersecurity', support: 'Technical, data, and product career case support' },
  { area: 'Engineering & Manufacturing', stats: ['1,900+ offers', '52 mentors'], tags: ['Mechanical', 'Electrical', 'Civil', 'Industrial', 'Biomedical Engineering'], roles: 'Engineering roles, project management, manufacturing, energy, medical devices, technical consulting', support: 'Engineering, manufacturing, and technical consulting path support' },
  { area: 'Media & Social Sciences', stats: ['1,400+ offers', '38 mentors'], tags: ['Communication', 'Psychology', 'Education', 'Public Policy', 'Media'], roles: 'Marketing, PR, user research, edtech, policy research, human resources', support: 'Marketing, communications, and user research mentor support' },
  { area: 'Life Sciences & Health', stats: ['1,100+ offers', '31 mentors'], tags: ['Biology', 'Chemistry', 'Public Health', 'Statistics', 'Math'], roles: 'Biopharma, healthcare consulting, research assistant roles, data analysis, healthcare business roles', support: 'Healthcare, research-to-business, and life science career support' },
  { area: 'Design & Creative', stats: ['820+ offers', '27 mentors'], tags: ['Design', 'HCI', 'Architecture', 'Fashion', 'Creative'], roles: 'UX/UI, brand design, creative marketing, architecture, fashion management', support: 'Portfolio, design recruiting, and creative role support' },
];

const MAJOR_RESOURCES = [
  { title: 'Industry Mentors', desc: 'Mentors cover technology, finance, consulting, data, product, marketing, engineering, and healthcare.' },
  { title: 'Proven Student Pathways', desc: 'Real paths from internships to full-time recruiting and career transitions across majors.' },
  { title: 'Job-Market Data', desc: 'Role requirements, skill keywords, and application trends help students choose better directions.' },
];
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        >
          ...
          <h3 className="text-[20px] font-semibold mb-1.5">Scan to get your personalized career plan</h3>
        ...
        <div className="px-7 py-6 text-center">
          ...
          >
            Open WeChat and add an advisor
          </a>
        </div>

        <div className="pb-5 text-center text-[11px] text-gray-400">
          The MentorX team helps guide your career journey.
        </div>
      </div>
    </div>
  );
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-8 pb-6 lg:pt-12 lg:pb-8">
        <div className="grid gap-8 md:grid-cols-[minmax(0,1fr)_minmax(250px,0.86fr)] md:gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.92fr)] lg:gap-8 items-center min-w-0">
          ...
          <div className="order-1 min-w-0" style={{ maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)' }}>
            ...
            >
              Career and Internship Planning for Students Across Majors
            </div>
            ...
            >
             Every Major Can Lead to the Right Career Path
            </h1>
            ...
            <h1
              ...
              style={{ color: INK, letterSpacing: '-0.04em', maxWidth: 'clamp(0px, calc(100vw - 40px), 34rem)', wordBreak: 'keep-all', overflowWrap: 'normal' }}
            >
              Different majors, better-fit career paths
            </h1>
            ...
            <p className="hidden text-[17px] leading-relaxed mb-5 max-w-[19rem] sm:max-w-md md:block" style={{ color: INK_MUTED, overflowWrap: 'anywhere' }}>
              Turn your academic background into a career strategy employers understand, with role targeting built around your major, skills, and goals.
            </p>
            ...
            <div className="grid grid-cols-3 gap-2 text-[10px] text-gray-500 sm:flex sm:flex-wrap sm:items-center sm:justify-start sm:gap-6 sm:text-[15px]">
              {['11+ years experience', '33,000+ students', '95% offer success rate'].map(t => (
                <div
                  key={t}
          ...
          <div className="order-2 flex justify-center md:justify-end min-w-0">
            <div className="relative w-full max-w-[350px] sm:max-w-[380px] md:w-[clamp(280px,38vw,420px)] md:max-w-none rounded-[16px]" style={{ boxShadow: '0 16px 48px rgba(17,24,39,0.08)' }}>
              ...
              {/* Floating badges */}
              <Badge text="11+ years supporting international students" className="-top-3 left-0 sm:-left-8" style={heroTagStyle(-28, -0.15)} />
              <Badge
                text="1:1 mentor guidance from top companies"
                sub="Tech · Finance · Consulting"
                className="hidden sm:flex sm:top-[28%] sm:-right-8"
                style={heroTagStyle(26, -1.15)}
              />
              <Badge text="OPT/H-1B career path planning" className="bottom-[18%] left-0 sm:-left-8" style={heroTagStyle(24, -2.05)} />
              ...
              >
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="text-[10px] font-medium text-gray-500">Offer landed</span>
                </div>
...
function LeadCaptureSection({ onCTA }: { onCTA: () => void }) {
  const items = [
    {
      title: 'Who It Helps',
      desc: 'International students facing unclear direction, limited experience, low response rates, or OPT/H-1B pressure.',
    },
    {
      title: 'What You Get',
    ...
    {
      title: 'Next Step',
      desc: 'Connect with an advisor to identify whether resume, projects, interviews, or role strategy should come first.',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-5 rounded-[16px] border bg-white p-5 sm:p-6" style={{ borderColor: HAIRLINE, boxShadow: '0 14px 44px rgba(17,24,39,0.06)' }}>
          ...
          <div className="rounded-[12px] p-5 text-white" style={{ background: GREEN_DARK }}>
            ...
            <h2 className="mb-3 text-[24px] font-semibold leading-tight" style={{ letterSpacing: '-0.02em' }}>Clarify the blocker first, then decide how to close the gap.</h2>
            <p className="mb-0 text-[14px] leading-relaxed text-white/70 md:mb-5">A simple consultation entry point: students do not need to understand every service first; the assessment helps turn interest into the right plan.</p>
            <button
              onClick={onCTA}
  ...
  return (
    <Sec id="solution" bg="white">
      <SecHead
        ...
        title="	Your Major Is Not the Limit. Strategy Is."
        sub="The challenge is not your major. It is knowing which roles to target, what experience to build, and how to translate coursework and projects into employer-ready value."
        center
      />
...
function MajorPathSection({ onCTA }: { onCTA: () => void }) {
  ...
  return (
    <Sec bg={CANVAS} className="pt-18">
      <SecHead
        eyebrow="Major-to-Career Coverage"
        title="Start With Your Major. Build the Right Career Path."
        sub="Every major has different role options, experience gaps, and preparation needs. MentorX combines industry mentors, real student cases, and job-market data to turn your academic background into career-ready positioning."
        center
      />
      ...
      >
            ...
            return (
              ...
              >
                ...
                <div className="mt-auto">
                  <div className="mb-1.5 text-[12px] font-medium" style={{ color: "#8A938D" }}>Potential role directions</div>
        ...
        <button
          type="button"
          aria-label="View previous major direction"
        ...
        <button
          type="button"
          aria-label="View next major direction"
          onClick={() => moveTo(activeIndex + 1)}
      ...
      <div className="mt-4 flex justify-center gap-2" aria-label="Major direction carousel pagination">
        {MAJOR_PATHS.map(({ area }, index) => (
          <button
            key={area}
            type="button"
            aria-label={"Switch to " + area}
      ...
      <div className="mt-14 text-center">
        <h3 className="text-[16px] font-semibold" style={{ color: INK }}>Every Path Comes With the Right Support</h3>
      ...
      <div className="hidden text-center mt-10 md:block">
        <Btn label="Evaluate My Career Direction" onClick={onCTA} size="lg" />
      </div>
    </Sec>
  );
}
...
const FLOW_STEPS_NEW = [
  { n: '01', title: 'Set Goals', desc: 'Clarify target countries, industries, roles, and job-search timeline.' },
  { n: '02', title: 'Gap Analysis', desc: 'Identify resume, skills, projects, and interview gaps.' },
  { n: '03', title: 'Path Planning', desc: 'Build phased tasks, learning priorities, and application rhythm.' },
  { n: '04', title: 'Career Training', desc: 'Improve competitiveness through courses, projects, and mentor coaching.' },
  { n: '05', title: 'Readiness Review', desc: 'Assess readiness and adjust the job-search strategy dynamically.' },
        ...
        <div className="order-1 lg:order-2">
          <div className="mb-8">
            ...
            <h2 className="text-[30px] sm:text-[34px] font-semibold mb-3 leading-tight" style={{ color: INK, letterSpacing: '-0.03em' }}>
              Start With Your Major.<br /> Build the Right Career Path.
            </h2>
...
const MENTORS = [
  { name: 'Dijkstra W.', title: 'Google Tech Lead', company: 'Google', years: '5+ years', strength: 'Lead SDE with end-to-end OA and interview experience', coaching: 'SDE technical interviews, project review', initials: 'DW', color: '#4285F4' },
  { name: 'Crystal Z.', title: 'Morgan Stanley FICC VP', company: 'Morgan Stanley', years: '6+ years', strength: 'Quant strategy and investment decision-making', coaching: 'Case interviews, investment analysis', initials: 'CZ', color: '#0076CF' },
  { name: 'Pengfei X.', title: 'IBM Principal Consultant', company: 'IBM', years: '20+ years', strength: 'Large-scale systems and project management', coaching: 'Consulting interviews, business analysis', initials: 'PX', color: '#006699' },
  { name: 'Hang Y.', title: 'TikTok Software Engineer', company: 'TikTok', years: '7 years', strength: 'Former Google engineer with campus recruiting experience', coaching: 'Algorithms, system design', initials: 'HY', color: '#010101' },
  { name: 'George Z.', title: 'Amazon Data Scientist', company: 'Amazon', years: '4 years', strength: 'Data science interview preparation for target roles', coaching: 'SQL, analytical interviews', initials: 'GZ', color: '#FF9900' },
  { name: 'Anna Z.', title: 'Apple SWE Program Manager', company: 'Apple', years: '5 years', strength: 'Former Tesla; cross-functional program leadership', coaching: 'Program management, project review', initials: 'AZ', color: '#1d1d1f' },
  { name: 'Kevin L.', title: 'McKinsey Senior Associate', company: 'McKinsey', years: '6+ years', strength: 'Strategy consulting with McKinsey recruiting experience', coaching: 'Case interviews, resume refinement', initials: 'KL', color: '#003B71' },
  { name: 'Sophia R.', title: 'Meta Product Manager', company: 'Meta', years: '4 years', strength: 'Cross-functional product lead with PM interview coaching experience', coaching: 'PM interviews, product design questions', initials: 'SR', color: '#0866FF' },
  { name: 'Michael T.', title: 'JPMorgan Quant Analyst', company: 'JPMorgan', years: '8+ years', strength: 'Quant finance and financial engineering interview coaching', coaching: 'Technical interviews, behavioral interviews', initials: 'MT', color: '#003087' },
  { name: 'Linda C.', title: 'Deloitte Senior Consultant', company: 'Deloitte', years: '5 years', strength: 'Audit and management consulting with Big Four campus recruiting experience', coaching: 'Case interviews, resume optimization', initials: 'LC', color: '#86BC25' },
];
    ...
    <section id="mentors" className="py-10 md:py-14 overflow-hidden" style={{ background: 'white' }}>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 mb-8">
        <SecHead
          ...
          title="Choose Your Direction With Mentors Who Know the Field"
          sub="Mentors from tech, finance, consulting, data, product, and more are matched to your target roles and career direction."
          center
        />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex flex-col items-center text-center mb-8 [&>div]:mb-0">
          <SecHead
            ...
            title="Different Majors. Real Career Paths."
            sub="From business to consulting and finance, from CS to product and data, from social sciences to marketing and PR, every career pivot starts with clear planning, focused preparation, and continuous feedback."
            center
          />
        </div>
    ...
    <Sec bg="white" id="aboutus" className="!py-14 sm:!py-16">
      <div className="text-center mb-8">
        <SecHead
            ...
            title="	Insight That Moves Careers Forward"
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-6 lg:gap-10 items-center">
          <div>
            ...
            <h2 className="text-[28px] sm:text-[36px] lg:text-[42px] font-semibold leading-tight mb-5" style={{ color: INK, letterSpacing: '-0.03em' }}>
              	Not Sure Where Your Major Can Take You?<br />
        
            </h2>
            <p className="text-[15px] mb-0 max-w-xl leading-relaxed md:mb-9" style={{ color: INK_MUTED }}>
              Start with a free assessment and find the path with the strongest potential for your background, goals, and timeline.
            </p>
            <button
              onClick={onCTA}
    ...
    <footer className="py-4" style={{ background: CANVAS }}>
      <div className="max-w-6xl mx-auto px-5 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="text-[12px]" style={{ color: INK_MUTED }}>
          ©2026, MentorX Education. All Rights Reserved · International student career coaching
        </div>
      </div>
    </footer>
  );
...
const NAV_ITEMS = [
  { id: 'solution', label: 'Career Plan' },
  { id: 'flow', label: 'Process' },
  { id: 'mentors', label: 'Mentors' },
  { id: 'success', label: 'Student Outcomes' },
